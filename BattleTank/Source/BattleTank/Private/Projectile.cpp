...
AProjectile::AProjectile()
{
	...
	ExplosionForce->AttachToComponent(RootComponent, FAttachmentTransformRules::KeepRelativeTransform); // always needs to have this if you want it to have transforms relative to the root
}
